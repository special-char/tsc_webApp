...
const Testimonial = ({ data }) => {
  ...
  return (
    <>
      <div className="relative flex flex-col md:flex-row items-center w-full py-11 px-6 md:py-24 md:px-14 md:p-12 gap-4 rounded-3xl drop-shadow-sm border-spacing-2  bg-neutral-100">
