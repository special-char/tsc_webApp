...
const Testimonial = ({
  ...
  return (
    <>
      <div className="flex  flex-col md:flex-row items-center w-full p-0 md:p-12 gap-9 rounded-3xl shadow-2xl border-spacing-2 drop-shadow-md bg-neutral-100">
        ...
        <div className="flex-col text-content-wrapper flex-1 flex gap-4 md:items-start items-center">
          {svg}
          <p className="text-lg text-center md:text-left font-normal text-neutral-600">
            {description}
          </p>
