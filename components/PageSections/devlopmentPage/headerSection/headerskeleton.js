  ...
  return (
    <>
      <section className="main flex items-center h-[30vh] sm:h-screen relative overflow-hidden py-16">
        <div className="container h-full flex-wrap items-center justify-center gap-16 max-w-7xl mx-auto px-8">
          <div className="h-full animate-pulse w-11/12 rounded-xl bg-neutral-300"></div>
