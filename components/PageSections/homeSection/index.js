...
const HomeSection = () => {
  return (
    <section className="h-auto lg:w-full relative border overflow-hidden pt-16 pb-16">
      <div className="flex flex-col md:container md:mx-auto lg:flex-row gap-3 px-4">
        <div className="flex flex-col lg:flex-col justify-center">
          <div className="flex flex-col text-center md:max-w-[80%] md:mx-auto lg:max-w-[99%] lg:mx-auto lg:text-left">
