...
const SplitScreen = ({
  ...
  return (
    <section
      className={`relative overflow-hidden landing-page-wrapper overflow-y-hidden transition-all flex flex-col w-screen
        lg:flex-row lg:flex-wrap ${
          !showDiv || (!trainingPage && !developmentPage) ? "h-screen" : "h-0"
        } `}
    >
      <div
          ...
          <>
            ...
            >
              ...
              <p
                className={
                  firstCard
                    ? "flex transition-all text-neutral-100"
              ...
              <button
                className="border-neutral-100 text-neutral-100 border px-4 py-2 rounded-md"
                onClick={() => {
                  if (firstCard) {
                    gotoDevelopment(true);
                    setShowDiv(true);
                  } else {
                    setFirstCard(true);
                  }
