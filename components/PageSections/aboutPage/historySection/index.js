...
const HistorySection = () => {
  return (
    <section className="py-44">
      <div className="flex flex-col gap-4 md:flex-row w-full container mx-auto px-3">
        ...
        <div className="right-content flex-1 border-l-2 border-neutral-300 max-h-[500px] overflow-y-scroll">
