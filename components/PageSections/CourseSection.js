        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="absolute z-10">
            <Button
              buttonText={"<"}
              buttonClass={
                "absolute z-10 top-48 -left-2 w-20 h-20 bg-[#FFFFFF] text-black text-2xl px-0 py-0 font-bold lg:"
              }
            />
            <Button
              buttonText={">"}
              buttonClass={
                "absolute z-10 top-48 left-72 w-20 h-20 bg-[#FFFFFF] text-black text-2xl font-bold text-white "
              }
            />
          </div>
          <div className="flex flex-col   lg:flex-row">
