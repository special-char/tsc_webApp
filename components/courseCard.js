    ...
    <div
      ...
      >
        <div>
          ...
          />
          <div className="">
            <Button buttonText={buttonText1} buttonClass={'absolute bg-[#e7eaee] px-4 py-3 font-bold top-10 right-10'}/>
            <Button buttonText={buttonText2} buttonClass={'absolute bg-[#064ea4] px-4 py-3 font-bold text-white top-24 right-10'} />
            {/* <a href="http://">
